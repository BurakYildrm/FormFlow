			...
			<div className="navbar bg-base-100">
				...
				<div className="flex-none">
					<ul className="menu menu-horizontal px-1">
						<li>
							<div className="dropdown dropdown-hover dropdown-bottom p-0 hover:bg-transparent">
								<label
									tabIndex={0}
								...
								<ul
									tabIndex={0}
									className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box m-0 w-fit"
								>
									<li>
										<Link
											href={pathname}
